...
class CloudflareR2Test(unittest.TestCase):
    ...
    def test_03_upload_sample_video(self):
        ...
        url = f"{API_URL}/projects/{CloudflareR2Test.project_id}/upload-sample"
    ...
    def test_04_upload_character_image(self):
        ...
        url = f"{API_URL}/projects/{CloudflareR2Test.project_id}/upload-character"
    ...
    def test_05_upload_audio(self):
        ...
        url = f"{API_URL}/projects/{CloudflareR2Test.project_id}/upload-audio"
    ...
    def test_06_get_project_details(self):
        ...
        url = f"{API_URL}/projects/{CloudflareR2Test.project_id}"
